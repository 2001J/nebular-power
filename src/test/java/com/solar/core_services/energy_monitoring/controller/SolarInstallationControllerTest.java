 ...
 * Source file: src/main/java/com/solar/core_services/energy_monitoring/controller/SolarInstallationController.java
 */
...
public class SolarInstallationControllerTest {
    ...
    public void testCreateInstallation() throws Exception {
        ...
        when(installationService.createInstallation(any(SolarInstallationDTO.class))).thenReturn(createdInstallationDTO);
    ...
    public void testUpdateInstallation() throws Exception {
        ...
        when(installationService.updateInstallation(eq(1L), any(SolarInstallationDTO.class))).thenReturn(updatedDTO);
    ...
    public void testUpdateDeviceStatus() throws Exception {
        // Given
        when(installationService.updateDeviceStatus(any(DeviceStatusRequest.class))).thenReturn(installationDTO1);
