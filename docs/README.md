...
Abstract
- A comprehensive platform enabling real‑time monitoring of solar production/consumption, financial management of financing plans, and detailed analytics. Built with Spring Boot, PostgreSQL, and Next.js/React, it provides role‑based access control, customizable dashboards, and automated reporting for installers, administrators, and customers.
